<div class="container full-width">
    ...
    <div class="row">
        <div class="col text-center mt-2 mb-2" id="portfolioBtnContainer">
    ...
    <div class="iframe-container">
        <iframe class="responsive-iframe" id="gallery-iframe" src="{{url('gallery')}}" title="SeiyraDesign Portfolio Gallery" style="border:none;"></iframe>
    </div>
</div>