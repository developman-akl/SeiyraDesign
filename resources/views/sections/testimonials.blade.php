                ...
                <div class="row">
                    <div class="col">
                        <div class="testimonial-name-container">
                            <img src="{{ asset('storage/'.$testimonial->image) }}" class="testimonial-image img-fluid" alt="{{ $testimonial->alt_text ? $testimonial->alt_text : $testimonial->company . ' testimonial' }}">
